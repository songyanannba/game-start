...
import (
	...
	"elim5/service/test/handler/repeat/unit9"
	"elim5/utils/helper"
	"fmt"
)
...
type Slot9 struct {
	...
	testSlot9 *unit9.Unit
}

func GetUnit9(t *gen_com.GenTemplate) *Slot9 {
	return &Slot9{
		testSlot9: unit9.NewUnit(),
		gTem:      t,
	}

}

func (s *Slot9) RunTem() ([]*component.Spin, error) {
	sp := &component.Spin{
...
func (s *Slot9) Calculate(spins []*component.Spin) {
	s.testSlot9.Calculate(spins) // 9
}

func (s *Slot9) GetStatus() (float64, string, bool) {
	r := s.GetLogicResult()
...
func (s *Slot9) GetLogicResult() *gen_com.LogicResult {
	res := s.testSlot9.Result
...
// Adjust slot8 调整数据
func (s *Slot9) Adjust(genc *gen_com.LogicResult) (str string, ok bool) {
