...
func GetUnit5(t *gen_com.GenTemplate) *Slot5 {
	return &Slot5{
...
func (s *Slot5) RunTem() ([]*component.Spin, error) {
	sp := &component.Spin{
...
// Calculate 累加数据
func (s *Slot5) Calculate(spins []*component.Spin) {
	s.testSlot15.Calculate(spins)
}

// GetLogicResult slot8 计算数据
func (s *Slot5) GetLogicResult() *gen_com.LogicResult {
...
func (s *Slot5) GetStatus() (totalInterval float64, str string, ok bool) {
	r := s.GetLogicResult()
...
// Adjust slot8 调整数据
func (s *Slot5) Adjust(genc *gen_com.LogicResult) (str string, ok bool) {
