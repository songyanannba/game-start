...
type Slot16 struct {
	...
	testSlot15 *unit5.Unit
}

func GetUnit16(t *gen_com.GenTemplate) *Slot16 {
	return &Slot16{
		testSlot15: unit5.NewUnit(),
		gTem:       t,
	}
}

func (s *Slot16) RunTem() ([]*component.Spin, error) {
	sp := &component.Spin{
...
// Calculate 累加数据
func (s *Slot16) Calculate(spins []*component.Spin) {
	s.testSlot15.Calculate(spins)
}

// GetLogicResult slot8 计算数据
func (s *Slot16) GetLogicResult() *gen_com.LogicResult {
...
func (s *Slot16) GetStatus() (totalInterval float64, str string, ok bool) {
	r := s.GetLogicResult()
...
// Adjust slot8 调整数据
func (s *Slot16) Adjust(genc *gen_com.LogicResult) (str string, ok bool) {
