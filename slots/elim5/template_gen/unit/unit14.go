...
func GetUnit14(t *gen_com.GenTemplate) *Slot14 {
	return &Slot14{
...
func (s *Slot14) RunTem() ([]*component.Spin, error) {
	sp := &component.Spin{
...
// Calculate 累加数据
func (s *Slot14) Calculate(spins []*component.Spin) {
	s.testSlot15.Calculate(spins)
}

// GetLogicResult slot8 计算数据
func (s *Slot14) GetLogicResult() *gen_com.LogicResult {
...
func (s *Slot14) GetStatus() (totalInterval float64, str string, ok bool) {
	r := s.GetLogicResult()
...
// Adjust slot8 调整数据
func (s *Slot14) Adjust(genc *gen_com.LogicResult) (str string, ok bool) {
