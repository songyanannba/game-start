...
import (
	...
	"elim5/service/test/handler/repeat/unit50"
	"fmt"
...
type Slot50 struct {
	...
	testSlot50 *unit50.Unit
}

func GetUnit50(t *gen_com.GenTemplate) *Slot50 {
	return &Slot50{
		testSlot50: unit50.NewUnit(),
		gTem:       t,
	}
}

func (s *Slot50) RunTem() ([]*component.Spin, error) {
	sp := &component.Spin{
...
func (s *Slot50) Calculate(spins []*component.Spin) {
	s.testSlot50.Calculate(spins) //
}

func (s *Slot50) GetStatus() (float64, string, bool) {
	r := s.GetLogicResult()
...
func (s *Slot50) GetLogicResult() *gen_com.LogicResult {
	res := s.testSlot50.Result
...
// Adjust  调整数据
func (s *Slot50) Adjust(genc *gen_com.LogicResult) (str string, ok bool) {
