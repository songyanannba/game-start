...
func GetUnit44(t *gen_com.GenTemplate) *Slot44 {
	return &Slot44{
...
func (s *Slot44) RunTem() ([]*component.Spin, error) {
	sp := &component.Spin{
...
// Calculate 累加数据
func (s *Slot44) Calculate(spins []*component.Spin) {
	s.testSlot25.Calculate(spins)
}

// GetLogicResult slot8 计算数据
func (s *Slot44) GetLogicResult() *gen_com.LogicResult {
...
func (s *Slot44) GetStatus() (totalInterval float64, str string, ok bool) {
	r := s.GetLogicResult()
...
// Adjust slot8 调整数据
func (s *Slot44) Adjust(genc *gen_com.LogicResult) (str string, ok bool) {
