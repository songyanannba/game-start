...
func GetUnit22(t *gen_com.GenTemplate) *Slot22 {
	return &Slot22{
...
func (s *Slot22) RunTem() ([]*component.Spin, error) {
	sp := &component.Spin{
...
// Calculate 累加数据
func (s *Slot22) Calculate(spins []*component.Spin) {
	s.testSlot15.Calculate(spins)
}

// GetLogicResult slot8 计算数据
func (s *Slot22) GetLogicResult() *gen_com.LogicResult {
...
func (s *Slot22) GetStatus() (totalInterval float64, str string, ok bool) {
	r := s.GetLogicResult()
...
// Adjust slot8 调整数据
func (s *Slot22) Adjust(genc *gen_com.LogicResult) (str string, ok bool) {
