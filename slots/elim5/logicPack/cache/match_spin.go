...
func PushMatchSpinAckCache(userId, slotId uint, typ int, acks ...*common.MatchSpinAck) error {
	var (
		arr []any
...
func PopMatchSpinAckCache(userId, slotId uint, typ int, ack *common.MatchSpinAck) error {
