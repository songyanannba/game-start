...
func PushFreeSpinAckCache(userId, slotId uint, typ int, acks ...*common.SpinAck) error {
	var (
		arr []any
...
func PopFreeSpinAckCache(userId, slotId uint, typ int, ack *common.SpinAck) error {
