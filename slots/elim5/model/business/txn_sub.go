...
type TxnSub struct {
	...
	Pid        uint      `json:"pid" form:"pid" gorm:"index;column:pid;default:0;comment:PID;size:32;"`
	RecordId   uint      `json:"recordId" form:"recordId" gorm:"index;column:record_id;default:0;comment:Record ID;size:64;"`
