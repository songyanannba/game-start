...
type Txn struct {
	global.GVA_MODEL
	Type       int    `json:"type" form:"type" gorm:"column:type;default:1;comment:Type;size:8;"`
	...
	TxnId    string `json:"txnId" form:"txnId" gorm:"index;column:txn_id;comment:Txn ID;size:50;"`
	...
	PlatformTxnId string `json:"platformTxnId" form:"platformTxnId" gorm:"index;column:platform_txn_id;comment:Platform Txn ID;size:100;"`
