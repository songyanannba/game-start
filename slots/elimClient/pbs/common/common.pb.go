...
type Tracking struct {
	...
	Type TrackingType `protobuf:"varint,2,opt,name=type,proto3,enum=common.TrackingType" json:"type,omitempty"` //埋点类型
}
...
type SpinOpt struct {
	...
	OptIdx  int32 `protobuf:"varint,6,opt,name=opt_idx,json=optIdx,proto3" json:"opt_idx,omitempty"`    //选项
}
...
func (x *SpinOpt) GetOptIdx() int32 {
	if x != nil {
		return x.OptIdx
	}
	return 0
...
// 游戏恢复数据
type GameRecover struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	GameId int32 `protobuf:"varint,1,opt,name=game_id,json=gameId,proto3" json:"game_id,omitempty"` // game_id
	StepId int32 `protobuf:"varint,2,opt,name=step_id,json=stepId,proto3" json:"step_id,omitempty"` // 当前步骤id
	Code   int32 `protobuf:"varint,3,opt,name=code,proto3" json:"code,omitempty"`                   // 状态码 0:正常 1:维护 2:关闭 3:未开放
}

func (x *GameRecover) Reset() {
	*x = GameRecover{}
	if protoimpl.UnsafeEnabled {
...
func (x *GameRecover) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GameRecover) ProtoMessage() {}

func (x *GameRecover) ProtoReflect() protoreflect.Message {
	mi := &file_proto_common_common_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GameRecover.ProtoReflect.Descriptor instead.
func (*GameRecover) Descriptor() ([]byte, []int) {
	return file_proto_common_common_proto_rawDescGZIP(), []int{8}
}

func (x *GameRecover) GetGameId() int32 {
	if x != nil {
		return x.GameId
	}
	return 0
...
func (x *GameRecover) GetStepId() int32 {
	if x != nil {
		return x.StepId
	}
	return 0
...
func (x *GameRecover) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_proto_common_common_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x6e, 0x22, 0x62, 0x0a, 0x08, 0x72, 0x65, 0x71, 0x5f, 0x68, 0x65, 0x61, 0x64, 0x12,
	...
	0x6f, 0x72, 0x6d, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x65, 0x6d, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x04, 0x64, 0x65, 0x6d, 0x6f, 0x22, 0x58, 0x0a, 0x08, 0x61, 0x63, 0x6b, 0x5f, 0x68,
	0x65, 0x61, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x03, 0x75, 0x69, 0x64, 0x12, 0x20, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x02, 0x20,
	...
	0x65, 0x22, 0x5c, 0x0a, 0x08, 0x72, 0x65, 0x63, 0x68, 0x61, 0x72, 0x67, 0x65, 0x12, 0x24, 0x0a,
	...
	0x65, 0x61, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20,
	...
	0x4c, 0x0a, 0x0c, 0x72, 0x65, 0x63, 0x68, 0x61, 0x72, 0x67, 0x65, 0x5f, 0x61, 0x63, 0x6b, 0x12,
	...
	0x04, 0x68, 0x65, 0x61, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x2e, 0x0a,
	0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x24, 0x0a, 0x04, 0x68, 0x65, 0x61, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x72,
	0x65, 0x71, 0x5f, 0x68, 0x65, 0x61, 0x64, 0x52, 0x04, 0x68, 0x65, 0x61, 0x64, 0x22, 0x4a, 0x0a,
	0x0a, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x61, 0x63, 0x6b, 0x12, 0x24, 0x0a, 0x04, 0x68,
	...
	,
	...
	,
...
var file_proto_common_common_proto_goTypes = []interface{}{
	...
	(TrackingType)(0),   // 1: common.tracking_type
	(*ReqHead)(nil),     // 2: common.req_head
	(*AckHead)(nil),     // 3: common.ack_head
	(*Recharge)(nil),    // 4: common.recharge
	(*RechargeAck)(nil), // 5: common.recharge_ack
	(*Amount)(nil),      // 6: common.amount
	(*AmountAck)(nil),   // 7: common.amount_ack
	(*Tracking)(nil),    // 8: common.tracking
	(*SpinOpt)(nil),     // 9: common.spin_opt
	(*GameRecover)(nil), // 10: common.game_recover
}
var file_proto_common_common_proto_depIdxs = []int32{
	0, // 0: common.ack_head.code:type_name -> common.Code
	2, // 1: common.recharge.head:type_name -> common.req_head
	3, // 2: common.recharge_ack.head:type_name -> common.ack_head
	2, // 3: common.amount.head:type_name -> common.req_head
	3, // 4: common.amount_ack.head:type_name -> common.ack_head
	2, // 5: common.tracking.head:type_name -> common.req_head
	1, // 6: common.tracking.type:type_name -> common.tracking_type
