...
type SlotRecord struct {
	...
	TxnId      uint   `json:"txnId" form:"txnId" gorm:"column:txn_id;default:0;comment:交易编号;size:32;"`
	Bet        int    `json:"bet" form:"bet" gorm:"column:bet;default:0;comment:押注;size:32;"`
	...
	Raise      int64  `json:"raise" form:"raise" gorm:"column:raise;default:0;comment:加注;size:32;"`
